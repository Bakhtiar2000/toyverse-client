            ...
            >
                ...
                <SwiperSlide className="text-white text-center bg-yellow-950   lg:max-w-lg md:max-w-md max-w-xs mx-auto rounded-2xl">
                    <div className="px-4 pt-8 pb-6">
                        ...
                        <p className="mb-10 bg-slate-100 text-black mx-5 py-3 px-5 rounded-lg">I have been collecting action figures for years, and I have to say this toy shop has one of the best selections I\'ve come across. The website is user-friendly, and the ordering process is seamless. The toys are of excellent quality. I highly recommend this shop to all action figure enthusiasts!</p>
                    </div>
                </SwiperSlide>
            </Swiper>
        </div>
